...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(UnrealizedMethodOfSendingException.class)
    protected ResponseEntity<String> handleUnrealizedMethodOfSendingException(UnrealizedMethodOfSendingException ex ) {
        LOGGER.info("Unrealized method of sending exception: %s".formatted(ex.getMessage()));
